...
# Pacman installs
echo $passvar | sudo -S pacman -Sy --noconfirm base-devel feh zsh pamixer neovim code kitty exa git light openssh neofetch xorg xorg-server xorg-apps dmenu unzip && sudo -k
